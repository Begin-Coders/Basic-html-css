...
buttons.button4.onclick = () => {
    document.getElementById('webpage-body-div').innerHTML = `<iframe src='./madhan-login/index.html'></iframe><button onclick="location.href='./madan-login/index.html'">Click to see in full screen</button>`
    design()
}

buttons.button5.onclick = () => {
    document.getElementById('webpage-body-div').innerHTML = `<iframe src='./tamz-login/index.html'></iframe><button onclick="location.href='./tamz-login/index.html'">Click to see in full screen</button>`
    design()
}